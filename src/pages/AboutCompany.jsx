...
function AboutCompany() {
  return (
    <div className="about-company">
      <h1>¿Qué es Interconectados?</h1>
      
      <section className="mission-section">
        <h2>¿Cuál es nuestra misión fundamental?</h2>
        <p>
      ...
      <section className="contribution-section">
        <h2>¿Qué queremos aportar al mundo?</h2>
        <ul>
          <li><strong>Fomentar Conexiones Profundas:</strong> Transformar la forma en que las personas se conectan en la era digital, promoviendo interacciones auténticas y significativas que trascienden lo superficial, fomentando amistades duraderas y apoyo mutuo.</li>
